...
#ifndef ECHO_MALLOCBASELINE_NO_MALLOC_H_
#define ECHO_MALLOCBASELINE_NO_MALLOC_H_
...
class malloc_baseline_no_malloc : public echo_message
{
    private: void * in_p;
    private: void * out_p;
    private: std::string out_string;
    private: std::string allocated_out_string;
    private: std::string allocated_in_string;
    ...
    public: malloc_baseline_no_malloc(uint32_t field_size, string message_type);
    public: ~malloc_baseline_no_malloc();
